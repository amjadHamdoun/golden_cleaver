...
import 'package:golden_cleaver/features/Screen/verify/verify2screen.dart';
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => Verify2Screen()),
                          );
                        },
                        child: Text(
                          "تحقق",
                          style: TextStyle(
                            fontSize: 18.sp,color: LightThemeColors.backgroundColor
                          ),
                        ),
