...
class ItemDetailsFromCategory extends StatefulWidget {
  ProductModel productModel;
  PagesBloc bloc;

   ItemDetailsFromCategory({Key? key,
     required this.productModel,
     required this.bloc
   }) : super(key: key);

  @override
  _ItemDetailsFromCategoryState createState() => _ItemDetailsFromCategoryState();
}

class _ItemDetailsFromCategoryState extends State<ItemDetailsFromCategory> {
